...
This app will be designed to both define and record necessary tasks, and allow user interface with and use of the application. 
...
<strong>Tentative Launch Date:</strong> TBD